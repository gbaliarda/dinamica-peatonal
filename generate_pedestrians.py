...
def generate_static_file():
    # Grid Length/maxRadius x Length/maxRadius
    amount_cells = math.ceil(BOX_LENGTH / PEDESTRIAN_MAX_RADIUS)
    ...
    with open(STATIC_FILE, "w") as f:
        for _ in range(PEDESTRIAN_AMOUNT):
            ...
            position_x = PEDESTRIAN_MAX_RADIUS * (index[0] + 1/2)
            position_y = PEDESTRIAN_MAX_RADIUS * (index[1] + 1/2)
